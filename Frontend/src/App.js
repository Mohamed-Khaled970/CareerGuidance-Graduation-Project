...
import InterviewsApp from "./DevRoots/pages/interview/InterviewsApp";
import AddInterview from "./Dashboard/pages/interview/AddInterview";
import ApplicantInterviews from "./Dashboard/pages/interview/ApplicantInterviews";
import AllInterviews from "Dashboard/pages/interview/AllInterviews";
import ScheduleInterview from "Dashboard/pages/interview/ScheduleInterview";
import AcceptedApplicants from "Dashboard/pages/interview/AcceptedApplicants";
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<DevRootsOutlet />}>
        ...
        <Route path="InterviewsApp" element={<InterviewsApp />} />
      ...
      <Route
        ...
        element={
          <ProtectedRoute
            allowedRoles={["admin", "Admin", "instructor", "Instructor"]}
          >
            <DashboardOutlet />
          </ProtectedRoute>
        }
      >
        ...
        <Route index element={<Navigate to="interview/add" />} />
        <Route path="interview/AddInterview" element={<AddInterview />} />

        <Route
          path="interview/ApplicantInterviews/:id"
          element={<ApplicantInterviews />}
        />
        <Route
          path="interview/allInterviews"
          element={<AllInterviews />}
        />
        <Route
          path="interview/acceptedInterviews"
